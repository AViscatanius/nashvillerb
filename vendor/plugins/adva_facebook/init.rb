# Having issues with Facebooker Loading properly
...
::FB_CALLBACK_URL = "http://#{Facebooker.facebooker_config['callback_url']}"
Mime::Type.register_alias 'text/html', :fbml 

require 'base_controller_include'
ActiveRecord::Base.observers << :fb_post_observer
ActiveRecord::Base.observers << :fb_event_observer


#allow deleting active record errors
...
register_javascript_expansion :fb_application => %w( adva_facebook/fb )
register_stylesheet_expansion :fb_application => %w( adva_facebook/fb )
