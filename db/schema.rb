...
ActiveRecord::Schema.define(:version => 20100323090000) do
  ...
  add_index "cached_page_references", ["object_id", "object_type"], :name => "index_cached_page_references_on_object_id_and_object_type"
  ...
  add_index "cached_pages", ["site_id", "url"], :name => "index_cached_pages_on_site_id_and_url"
